...
#ifdef GLES2
#error("GLES2 headers not added.")
#endif

#define DCFX_GL_MAJOR_VERSION 2
#define DCFX_GL_MINOR_VERSION 1
...
namespace dcfx
{
...
#else
    static const GLenum s_bufferMap[] = { GL_ARRAY_BUFFER, GL_ELEMENT_ARRAY_BUFFER };
#endif

#ifndef GLES2    
    static const GLenum s_shaderMap[] = { GL_VERTEX_SHADER, GL_FRAGMENT_SHADER, GL_COMPUTE_SHADER };
#else
    static const GLenum s_shaderMap[] = { GL_VERTEX_SHADER, GL_FRAGMENT_SHADER };
#endif
	...
	GLuint m_handle;
	// TODO: Should probely be allocated dynamicly.
	ProgramBuffer m_uniforms;
	GLPredfinedUniform m_predefined[8]; // NOTE: Define for this constant?
...
*/
    ...
    {
	void create(GLTexture* textures, TextureHandle* handles, uint32_t num);
	void destroy();
