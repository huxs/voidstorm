...
#define DCFX_SAMPLER_DEFAULT_POINT					\
    (DCFX_SAMPLER_MAG_NEAREST | DCFX_SAMPLER_MIN_NEAREST |		\
     DCFX_EDGE_FUNC(DCFX_SAMPLER_EDGE_CLAMP_BORDER, DCFX_SAMPLER_EDGE_CLAMP_BORDER, DCFX_SAMPLER_EDGE_CLAMP_BORDER))

#define DCFX_SAMPLER_DEFAULT						\
    (DCFX_SAMPLER_MAG_LINEAR | DCFX_SAMPLER_MIN_LINEAR |		\
     DCFX_EDGE_FUNC(DCFX_SAMPLER_EDGE_REPEAT, DCFX_SAMPLER_EDGE_REPEAT, DCFX_SAMPLER_EDGE_REPEAT))

#define DCFX_SAMPLER_DEFAULT_MIP					\
    (DCFX_SAMPLER_MAG_LINEAR | DCFX_SAMPLER_MIN_LINEAR_MIP_LINEAR |	\
     DCFX_EDGE_FUNC(DCFX_SAMPLER_EDGE_REPEAT, DCFX_SAMPLER_EDGE_REPEAT, DCFX_SAMPLER_EDGE_REPEAT))
